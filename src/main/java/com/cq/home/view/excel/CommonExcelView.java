...
public class CommonExcelView extends AbstractView{
	...
	protected final void renderMergedOutputModel(
		...
		if(this.workbook  == null) {
			...
			if(this.convertType != null && this.dataCollection != null) {
				//写入数据
				ExcelFieldProcessor excelFieldProcessor = new ExcelFieldProcessor(this.convertType);
				excelFieldProcessor.write(dataCollection);
				excelFieldProcessor.autoSizeColumn();//可选操作
				this.workbook = excelFieldProcessor.getWorkbook();
			}
		}
