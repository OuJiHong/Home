...
public class ExcelFieldProcessor<T> {
	 ...
	 */
	public ExcelFieldProcessor(Workbook workbook, Class<T> convertType) {
	 ...
	 * @return
	 */
	private List<MappingEntry> generatedMappingEntries(Class<T> convertType){
	 ...
	 * @return
	 */
	public Workbook process(Collection<T> dataCollection) {
